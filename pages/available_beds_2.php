...
<html>
    ...
    <h1>Available Beds</h1>
        ...
        $sql = "SELECT hospital_name, beds, available_bed, location, contact, date FROM available_beds order by id desc";
        ...
        <table class = "table myTable1">
            ...
            echo "<thead>";
                echo "<tr>";
                    ...
                    echo "<th scope = 'col'> Total Beds  </th> ";
                    echo "<th scope = 'col'> Available Beds </th> ";
