...
<html>
    ...
    <h1>Blood Bank Information</h1>
        ...
        $sql = "SELECT blood_banks, a_positive, a_negative, b_positive, b_negative, ab_positive, ab_negative, o_positive, o_negative, location, contact, date FROM blood_bank order by id desc";
 ...
 <script src="../index0.js" charset="utf-8"></script>t>
