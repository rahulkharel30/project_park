...
<body>
    ...
    <div class="form-box container-fluid">
        ...
        <tr>
            ...
            <td>
                <a class = "btn btn-outline-primary" href = "forms/available_beds_inputs.php">Here</a>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                <a class = "btn btn-outline-primary" href = "forms/blood_bank_inputs.php">Here</a>
        ...
        <tr>
            ...
            <td>
                <a class = "btn btn-outline-primary" href = "forms/doctor_appointment_inputs.php">Here</a>
            </td>
        </tr>
